...
def validate_single_rule(
    ...
    """
        ...
        Returns Rule object if valid otherwise raises InvalidRuleSchemaError or InvalidPatternNameError
    """
    ...
    # Raises InvalidRuleSchemaError or InvalidPatternNameError if fails to parse
